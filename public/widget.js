...
.ssm-card-img{width:100%;aspect-ratio:3/4;border-radius:8px;margin-bottom:8px;background-repeat:no-repeat;overflow:hidden;}
  ...
  const STEPS = [
    ...
    {
      id: "katif", type: "cards", yPos: 15,
      q: "ما شكل كتفيك؟", hint: "اختر الوصف الأقرب لشكل كتفيك.",
      options: [
        { v: "wide",   label: "عريضة", img: "images/q-shoulders-f.jpg", panel: 2, panelM: 0 },
        { v: "normal", label: "عادية", img: "images/q-shoulders-f.jpg", panel: 1, panelM: 1 },
        { v: "slim",   label: "رقيقة", img: "images/q-shoulders-f.jpg", panel: 0, panelM: 2 },
      ],
    },
    {
      id: "sadr", type: "cards", yPos: 20,
      q: "ما حجم صدرك؟", hint: "اختر الوصف الأقرب لمنطقة الصدر.",
      options: [
        { v: "big",    label: "كبير", img: "images/q-chest-f.jpg", panel: 0 },
        { v: "normal", label: "عادي", img: "images/q-chest-f.jpg", panel: 1 },
        { v: "slim",   label: "صغير", img: "images/q-chest-f.jpg", panel: 2 },
      ],
    },
    {
      id: "khasr", type: "cards", yPos: 40,
      q: "ما حجم خصرك؟", hint: "اختر الوصف الأقرب لمنطقة الخصر.",
      options: [
        { v: "slim",   label: "ضيق",  img: "images/q-waist-f.jpg", panel: 0 },
        { v: "normal", label: "عادي", img: "images/q-waist-f.jpg", panel: 1 },
        { v: "big",    label: "كبير", img: "images/q-waist-f.jpg", panel: 2 },
      ],
    },
    {
      id: "warek", type: "cards", yPos: 38,
      q: "ما حجم وركيك؟", hint: "اختر الوصف الأقرب لمنطقة الورك.",
      options: [
        { v: "big",    label: "كبير", img: "images/q-hips-f.jpg", panel: 2, panelM: 0 },
        { v: "normal", label: "عادي", img: "images/q-hips-f.jpg", panel: 1, panelM: 1 },
        { v: "slim",   label: "ضيق",  img: "images/q-hips-f.jpg", panel: 0, panelM: 2 },
      ],
    },
  ];
  ...
  function inject() {
    ...
    console.log('SSM tag=' + tag + ' | title=' + readProductTitle() + ' | tags=' + JSON.stringify(_merchantTags));
    if (!tag) return;
  ...
  function submit() {
    ...
    fetch(`${API_BASE}/api/calculate-size`, {
      ...
      body: JSON.stringify({
        ...
        katif:  answers.katif  || "normal",
        sadr:   answers.sadr   || "normal",
        khasr:  answers.khasr  || "normal",
        warek:  answers.warek  || "normal",
      }),
    })
      .then(r => {
